...
# Les arguments :
#   recherche       char, la recherche a effectuer sur twitter
#
#   nn               numeric, le nombre de tweet a recuperer
#
#   langue          par defaut "fr", la langue des tweets a recuperer (Ex : "fr", "en")
#
...
classtwitter <- function(recherche, Lexique, nn, langue="fr", dictionnaire=NULL, motimp=NULL, seuilTot=3.4, seuilIntra=64, seuilNeutre=0){
  ...
  cleanCorpus <- function(corpus){
    ...
    corpus <- tm_map(corpus, content_transformer(gsub), pattern = 'ô', replacement = 'o')
